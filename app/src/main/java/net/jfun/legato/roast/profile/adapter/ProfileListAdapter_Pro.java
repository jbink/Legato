...
public class ProfileListAdapter_Pro extends BaseAdapter {
...
//    private boolean mBoolShowEntireData = true;
    ...
    public ProfileListAdapter_Pro(Context context, ProfileListFragment profileListFragment) {
...
//        }
        ...
        holder.pencil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                profileListFragment.modifyList(data.getUid(), Constant.PROFILE_TYPE_PRO);
            }
        });
